...
If you generate a new process using the AO Starter Kit, the directory structure of the process will look somewhat like this:
...
:::tip
AO Starter Kit generates a sample test case for the process. You can modify the sample test case to write your own test cases.
:::
...
Ao Starter Kit provides a test script that can be used to run the tests for the process. The test script is located in the `./ao/process-name/scripts` directory of the process.
...
:::tip[Handy Tip]
Ao Starter Kit provides a shortcut to run the tests for the process. You can run the tests for the process using the following command from the project root:
