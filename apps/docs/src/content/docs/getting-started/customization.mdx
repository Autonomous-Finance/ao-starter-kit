...
<Notice type="tip">The size of the logo will adapt automatically</Notice>
...
<Code client:load extension="html" fileName="head.html">
```html
...
<Code client:load extension="json" fileName="theme.json">
```json
{
  "colors": {
    "default": {
