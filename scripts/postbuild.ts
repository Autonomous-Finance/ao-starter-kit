...
// Copy index.html
fs.copyFileSync(
  resolve(import.meta.dir, '../vocs/vite/index.html'),
  resolve(import.meta.dir, '../vocs/_lib/vite/index.html'),
)

// Copy public folder
fs.copy(
  resolve(import.meta.dir, '../vocs/app/public'),
  resolve(import.meta.dir, '../vocs/_lib/app/public'),
)

rewriteExtensions(resolve(import.meta.dir, '../vocs/_lib'))
rewriteMdxPlugin()
...
function rewriteMdxPlugin() {
  const path = resolve(import.meta.dir, '../vocs/_lib/vite/plugins/mdx.js')
